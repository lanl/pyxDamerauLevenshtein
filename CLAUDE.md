...
Releases are triggered manually via the **Build_and_Release** GitHub Actions workflow. Provide the version number (e.g. `1.9.0`) as input. The workflow builds wheels for Linux/macOS/Windows across all supported Python versions, creates a GitHub release, and publishes to PyPI.
